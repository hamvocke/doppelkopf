...
def test_merge_toggles():
    ...
    code_and_db = Toggle(name="db-and-code", description="a toggle thats defined in code and database", enabled=True)
    code_only = Toggle(name="code-only", description="a toggle thats only defined in code", enabled=False)
